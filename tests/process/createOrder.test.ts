...
describe('CreateOrder', () => {
    ...
    it('check incorrecnt exchange', () => {
        ...
        createOrder.onMessage({exchange: 'exch', symbol: 'symb', type: 'limit', side: 'sell', amount: 123}, testMessage);
    ...
    it('check create order', () => {
        ...
        createOrder.onMessage({exchange: 'kraken', symbol: 'symb', type: 'limit', side: 'sell', amount: 123}, testMessage);
